...
public class CubeFactory : MonoBehaviour
{
    ...
    private Stack<GameObject> woodWarehouse = new Stack<GameObject>();    //나무창고 스택
    private Stack<GameObject> metalWarehouse = new Stack<GameObject>();   //금속창고 스택
    ...
    void OnGUI()
    {
        ...
        GUI.Label(new Rect(10, 40, 250, 20), $"완료 큐 (Queue) : {materialQueue.Count}개 대기");
        GUI.Label(new Rect(10, 60, 250, 20), $"나무 창고 큐 (Stack) : {woodWarehouse.Count}개 ");
        GUI.Label(new Rect(10, 80, 250, 20), $"금속 창고 큐 (Stack) : {metalWarehouse.Count}개 ");
